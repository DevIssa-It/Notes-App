...
template.innerHTML = `
  <style>
    ...
    .meta{font-size:0.85rem;color:#94a3b8;font-style:italic;}
    .btn{
    ...
    .exportBtn:hover{
      ...
      border-color:#10b981;
      color:white;
      box-shadow:0 6px 16px rgba(5,150,105,0.4), 0 2px 6px rgba(0,0,0,0.4);
    }
    .importBtn:hover{
      background:#0284c7;
      border-color:#0ea5e9;
      color:white;
      box-shadow:0 6px 16px rgba(2,132,199,0.4), 0 2px 6px rgba(0,0,0,0.4);
    }
